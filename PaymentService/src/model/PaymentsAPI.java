...
public class PaymentsAPI extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String output = paymentObj.insertPayments(request.getParameter("paymentCode"), request.getParameter("paymentType"),
				request.getParameter("paymentAmount"), request.getParameter("paymentDesc"));
